...
The aim of the task is to maximise the prophet made over a series of tasks.
...
Each of the component's cannot be fully separated into unique sections as there is an order that they must be completed in.
...
Target shows us which element in Fig \ref{fig:interface} a participant is interacting with, and event\_type details the type of interaction.
The time field shows us the time taken in seconds since the first recorded mouse event.
