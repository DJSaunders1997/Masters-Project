...
\begin{abstract} 
    ...
    It was found that potentially between 4.4\% and 50.9\% of the crowdsourced users were paying attention, which highlights the known inaccuracies of crowdsourcing data.
...
These will consist of both raw and created features.
...
Lastly we have the 345 users not identified by the intersection of the models.
