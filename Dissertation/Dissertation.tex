...
The parameters $(A,B,\pi)$ are all learned during training, so do not need to be specified (REF).
...
\begin{figure}[ht]
    ...
    \caption{Histogram of length of mouse events sequences for turk and lab data.}
    \label{fig:normaldis}
\end{figure}
