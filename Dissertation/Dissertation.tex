...
% TODO: Maybe add a sample of training data here.
...
% Talk about how there was conserns with the mouse data not being centred on the same points or sliders.
% P

\subsection{Results}
The new HMMs reclassified none of the lab data and 22 of the crowdsourced turk users.
The previous HMM classified 45 of the crowdsourced users.
...
There is no intersection between the two sets of users.
This indicates either that there is no consistency in the results.

However this result is only if we look at the users that were reclassified, meaning their different in likelihoods of belonging to the Lab model and Turk model was positive.
If we amend the definition of a reclassified user to be the top 100 users with a positive difference in Likelihood then we get a different result.
The intersection between the top 100 reclassified users and the original set of reclassified users is 22.
This is much more promising as it shows that the majority of the reclassified users are shared between both methods.
% Say what I'm trying to say much better.
The inconsistency in the mouse location data identified could be causing the slight differences in methods. 
