...
\begin{abstract} 
    ...
    Some user's interaction seem misplaced compared to their groups.
...
Additionally the rationale of this is that regardless of which variant of the interface a lab study user was using they would be paying attention.
...
Thus, tracking a use's gaze can provide insight into which part of a system they're engaged with, and how much so.
...
For the main model of this dissertation it was decided to use only the series of mouse events and ignored the timestamps of the event. % WHY
...
% TODO: Check that this isnt befoer I mention bag-of-words models in my diss.
With bag of words models we ignore all order to the sequences looking only at the frequency of each item.
...
\begin{table}[ht]
    ...
    \begin{tabular}{llll}
        ...
        200             & 43.4\%                & Sequence Data model only         & Low  \\  \hline
    \end{tabular}
\end{table}
