...
Given a sequence of input data the HMM model can calculate the parameters of the model such as the transition matrix by using the Viterbi algorithm \cite{hmmlearn}.
...
Bigrams will be of particular interest as they show the transitions from one target to another.
...
With a combination of 1-grams, 2-grams, and 3-grams we now have X number of feature columns.
