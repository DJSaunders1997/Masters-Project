function compareOverViewGraph(container, nameContainer){
  var svg = d3.select("#svg_compareOverViewGraph"),
  ...
  g.append("g")
    ...
    .enter().append("path")
      ...
      .attr("interface", function(d){ if(d.id == "mean"){return "mean";}var xy = data.filter(function(k){ return k.id == d.id;}); return xy[0]['interface']}) 
